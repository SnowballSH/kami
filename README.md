...
| [`docs/hardware.md`](docs/hardware.md) | Cabinet wiring, server serial adapter, firmware protocol and outstanding physical checks; see the [integration guide](docs/architecture.md#controllers-and-voice). |
