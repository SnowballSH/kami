# Kami — Engineering Notes

Companion to `spec.md`. The spec says **what** Kami is; this file keeps the **how** that was already worked out, so nobody re-derives it at 3 a.m. Nothing here needs deciding now.
